...
import { buildLexiconDocs } from './docs.js';
import { compileLexiconDocs } from './compile.js';
 ...
 */
export function writeLexiconDocs(outputDir, docs) {
 ...
 */
export function validateRecords(records, schemas, relativeFile) {
    const diagnostics = [];
